...
type PropertyType = 'Att/Row/Townhouse' | 'Cottage' | 'Detached' | 'Duplex' | 'Farm' | 'Fourplex' | 
  ...
  export default function CreateListingPage() {
    ...
    const [exteriorDetails, setExteriorDetails] = useState<ExteriorDetails>({
      propertyType: '',
      link: false,
  ...
  const handleExteriorFeaturesChange = (features: any) => {
    console.log('Updating exterior features:', features);
    setExteriorDetails({
      ...exteriorDetails,
      ...features,
      exteriorMaterial: features.exteriorMaterial,
      utilities: {
    ...
    const isStepComplete = 
      ...
      typeof features.link === 'boolean' &&
      typeof features.parcelOfTiedLand === 'boolean' &&
      features.exteriorMaterial.length > 0 &&
      features.utilities.water &&
      features.utilities.sewers;
          ...
          case 3:
            return (
              <ExteriorFeatures
                exteriorFeatures={{
                  propertyType: exteriorDetails.propertyType,
                  propertyClass: exteriorDetails.propertyClass,
                  link: exteriorDetails.link,
                  parcelOfTiedLand: exteriorDetails.parcelOfTiedLand,
                  exteriorMaterial: exteriorDetails.exteriorMaterial || [],
                  exteriorFeatures: exteriorDetails.exteriorFeatures || [],
                  utilities: {
                    water: exteriorDetails.utilities?.water || '',
                    sewers: exteriorDetails.utilities?.sewers || '',
                    pool: exteriorDetails.utilities?.pool || ''
                  }
                }}
                onFeaturesChange={(features) => {
                  ...
                  // Remove the setSteps call as it's not needed
                  // We're already using markStepComplete elsewhere
                }}
                onContinue={() => {
                  setCurrentStep(4);
                  markStepComplete(3);
